...
async def run(playwright: Playwright) -> None:
    ...
    await page.get_by_label("Arbeitsmappe Arbeitsmappen").get_by_label("Mehr … (A)").click()
    await page.get_by_role("menuitem", name="Umbenennen …").click()
    await page.get_by_role("button", name="Abbrechen").click()
    await page.close()
